...
ad = 'c:/dev/Python/Repos/dfs-model/nba/data/archive/'
md = 'c:/dev/Python/Repos/dfs-model/nba/data/master/'
...
fc_actual_filename = 'fanduel_NBA_actual.csv'
